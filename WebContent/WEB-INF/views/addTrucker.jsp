...
<head>
  ...
  $(function() {
    ...
    $('#btnSaveTrucker').click(function()
     { 
    	var truckerName=$('#truckerName').val();var truckerAddress=$('#truckerAddress').val();var contactNumber=$('#contactNumber').val();
    	 if((truckerName.length<=0 || truckerName=='null') && (truckerAddress.length<=0 || truckerAddress=='null')&& (contactNumber.length<=0 || contactNumber=='null')){
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">	
			 <h3><a href="truckeradd.html">Add More Trucker</a></h3>
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> Trucker</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/truckersave.html"  id="frmTrucker" name="frmTrucker">
			...
			<tr>
			        <td class="center"><form:label path="truckerId">ID:</form:label></td>
			        <td  class="center"><form:input path="truckerId" value="${trucker.truckerId}" readonly="true"/></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="truckerName">Name:</form:label></td>
			        <td class="center"><form:input path="truckerName" value="${trucker.truckerName}"/><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="truckerAddress">Address :</form:label></td>
			        <td class="center"><form:input path="truckerAddress" value="${trucker.truckerAddress}"/><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><label>Location Id:</label></td>
			     <td>    <form:select id="locationId" path="locationId">
 <form:options items="${locations}"  itemValue="locationId" itemLabel="locationMerge"/>
			    ...
			    <tr>
                    ...
                    <td class="center"><form:input path="contactNumber" value="${trucker.contactNumber}" maxlength="10"/><a>*</a></td>
			    </tr>
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveTrucker"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List Truckers</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<c:if test="${!empty truckers}">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th>Id</th>
						  ...
						  <tbody>
							<c:forEach items="${truckers}" var="trucker">
			<tr>
				<td class="center"><c:out value="${trucker.truckerId}"/></td>
				<td class="center"><c:out value="${trucker.truckerName}"/></td>
				<td class="center"><c:out value="${trucker.truckerAddress}"/></td>
				<td class="center"><c:out value="${trucker.locationId}"/></td>
				<td class="center"><c:out value="${trucker.contactNumber}"/></td>
				<td align="center"><a class="btn btn-info" href="editTrucker.html?truckerId=${trucker.truckerId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteTrucker.html?truckerId=${trucker.truckerId}">
