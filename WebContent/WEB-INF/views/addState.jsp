	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">	
				...
				<h3><a href="stateadd.html">Add More State</a></h3>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> State</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/statesave.html" id="frmState">
			...
			<tr>
			        <td class="center"><form:label path="stateId">State ID:</form:label></td>
			        <td  class="center"><form:input path="stateId" value="${state.stateId}" readonly="true"/></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="stateName">State Name:</form:label></td>
			        <td class="center"><form:input path="stateName" value="${state.stateName}"/><a>*</a></td>
			    </tr>
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveState"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List States</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
			...
			<tr>
				<td class="center"><c:out value="${state.stateId}"/></td>
				<td class="center"><c:out value="${state.stateName}"/></td>
				<td align="center"><a class="btn btn-info" href="editState.html?stateId=${state.stateId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteState.html?stateId=${state.stateId}">
