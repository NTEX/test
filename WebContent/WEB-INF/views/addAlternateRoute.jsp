...
<head>
  ...
  $(function() {
    ...
    $('#btnSaveAlternateRoute').click(function()
     { 
    	var alternateRouteId=$('#alternateRouteId').val();  
    	if((alternateRouteId.length<=0 || alternateRouteId=='null')){
    			alert("Please enter alternate route id !");
    			$('#alternateRouteId').focus();
    			return false;
    	}
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">	
				...
				<h3><a href="alternateRouteadd.html">Add More Alternate Route</a></h3>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> Alternate Route</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/alternateRoutesave.html" id="frmAlternateRoute">
			...
			<tr>
			        <td class="center"><form:label path="alternateRouteId">Alternate Route ID:</form:label></td>
			        <td  class="center"><form:input path="alternateRouteId" value="${alternateRoute.alternateRouteId}" readonly=""/><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="routeId">Route ID:</form:label></td>
 ...
 <form:options items="${routes}"  itemValue="routeId" itemLabel="routeId"/>
			    ...
			    <tr>
			        <td class="center"><form:label path="status">Status:</form:label></td>
                    <td class="center"><form:select id="status" path="status">
 <form:options items="${states}"  itemValue="status" itemLabel="status"/>
         </form:select><a>*</a></td>
			    </tr>
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveAlternateRoute"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List Alternate Routes</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<c:if test="${!empty alternateRoutes}">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th>Alternate Route Id</th>
								  <th> Route ID</th>
						  ...
						  <tbody>
							<c:forEach items="${alternateRoutes}" var="alternateRoute">
			<tr>
				<td class="center"><c:out value="${alternateRoute.alternateRouteId}"/></td>
				<td class="center"><c:out value="${alternateRoute.routeId}"/></td>
				<td class="center"><c:out value="${alternateRoute.originLocationId}"/></td>
				<td class="center"><c:out value="${alternateRoute.destinationLocationId}"/></td>
				<td class="center"><c:out value="${alternateRoute.status}"/></td>
				<td align="center"><a class="btn btn-info" href="editAlternateRoute.html?alternateRouteId=${alternateRoute.alternateRouteId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteAlternateRoute.html?alternateRouteId=${alternateRoute.alternateRouteId}">
