...
<head>
  ...
  $(function() {
    ...
    $('#btnSaveTruck').click(function()
     { 
    	var truckNumber=$('#truckNumber').val();var truckCapacity=$('#truckCapacity').val();
    	 if((truckNumber.length<=0 || truckNumber=='null') && (truckCapacity.length<=0 || truckCapacity=='null')){
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<h3><a href="truckadd.html">Add More Truck</a></h3>
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> Truck</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/trucksave.html" id="frmTruck" name="frmTruck">
			...
			<tr>
			        <td class="center"><form:label path="truckId">Truck ID:</form:label></td>
			        <td  class="center"><form:input path="truckId" value="${truck.truckId}" readonly="true"/></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="truckNumber">Truck Number:</form:label></td>
			        <td class="center"><form:input path="truckNumber" value="${truck.truckNumber}"/><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><label>Trucker Id:</label></td>
			        <td class="center"><form:select id="truckerId" path="truckerId">
 <form:options items="${truckers}"  itemValue="truckerId" itemLabel="truckerName"/>
         </form:select><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="truckCapacity">Capacity:</form:label></td>
			        
			         <td class="center"><form:input path="truckCapacity" value="${truck.truckCapacity}"/><a>*</a></td>
			    </tr>
			    
			    <tr>
			        <td class="center"><label>Route Id:</label></td>
                    <td class="center"><form:select id="routeId" path="routeId">
 <form:options items="${routes}"  itemValue="routeId" itemLabel="routeId"/>
         </form:select> <a>*</a></td>
			    </tr>
			    
			     <tr>
			        <td class="center"><label>Status:</label></td>
                    <td class="center"><form:select id="status" path="status">
 <form:options items="${states}"  itemValue="status" itemLabel="status"/>
         </form:select><a>*</a></td>
			    </tr>
			    
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveTruck"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List Trucks</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
			...
			<tr>
				<td class="center"><c:out value="${truck.truckId}"/></td>
				<td class="center"><c:out value="${truck.truckNumber}"/></td>
				<td class="center"><c:out value="${truck.truckerId}"/></td>
				<td class="center"><c:out value="${truck.truckCapacity}"/></td>
				<td class="center"><c:out value="${truck.routeId}"/></td>
				<td class="center"><c:out value="${truck.status}"/></td>
				<td align="center"><a class="btn btn-info" href="editTruck.html?truckId=${truck.truckId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteTruck.html?truckId=${truck.truckId}">
