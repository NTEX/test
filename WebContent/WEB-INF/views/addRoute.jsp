    ...
    $('#btnSaveRoute').click(function()
     { 
    	var routeId=$('#routeId').val();
    	 if((routeId.length<=0 || routeId=='null')){
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">	
				...
				<h3><a href="routeadd.html">Add More Route</a></h3>
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> Route</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/routesave.html" id="frmRoute">
			...
			<tr>
			        ...
			        <td  class="center"><form:input path="routeId" value="${route.routeId}" readonly=""/><a>*</a></td>
			    </tr>
			    <tr>
 ...
 <form:options items="${states}"  itemValue="status" itemLabel="status"/>
			    ...
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveRoute"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List Routes</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
			...
			<tr>
				<td class="center"><c:out value="${route.routeId}"/></td>
				<td class="center"><c:out value="${route.originLocationId}"/></td>
				<td class="center"><c:out value="${route.destinationLocationId}"/></td>
				<td class="center"><c:out value="${route.status}"/></td>
				<td align="center"><a class="btn btn-info" href="editRoute.html?routeId=${route.routeId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteRoute.html?routeId=${route.routeId}">
