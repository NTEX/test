...
<head>
  ...
  $(function() {
    ...
    $('#btnSaveTransporter').click(function()
     { 
    	var transporterName=$('#transporterName').val();var transporterAddress=$('#transporterAddress').val();var contactNumber=$('#contactNumber').val();
    	 if((transporterName.length<=0 || transporterName=='null') && (transporterAddress.length<=0 || transporterAddress=='null')&& (contactNumber.length<=0 || contactNumber=='null')){
...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">	
			 <h3><a href="transporteradd.html">Add More Transporter</a></h3>
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span> Transporter</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<form:form method="POST" action="/TPGApps/transportersave.html" id="frmTransporter">
			...
			<tr>
			        <td class="center"><form:label path="transporterId">ID:</form:label></td>
			        <td  class="center"><form:input path="transporterId" value="${transporter.transporterId}" readonly="true"/></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="transporterName">Name:</form:label></td>
			        <td class="center"><form:input path="transporterName" value="${transporter.transporterName}"/><a>*</a></td>
			    </tr>
			    <tr>
			        <td class="center"><form:label path="transporterAddress">Address :</form:label></td>
			        <td class="center"><form:input path="transporterAddress" value="${transporter.transporterAddress}"/><a>*</a></td>
			    </tr>
			    <tr>
 ...
 <form:options items="${locations}"  itemValue="locationId" itemLabel="locationMerge"/>
         </form:select> <a>*</a></td>
			    </tr>
			    
			    <tr>
			        <td class="center"><form:label path="contactNumber">Contact Number:</form:label></td>
                    <td class="center"><form:input path="contactNumber" value="${transporter.contactNumber}" maxlength="10"/><a>*</a></td>
			    </tr>
			    <tr>
			      <td class="center" colspan="2"><input type="submit" value="Submit" id="btnSaveTransporter"/></td>
		      </tr>
			...
			<div class="row-fluid sortable">	
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>List Transporters</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
					<c:if test="${!empty transporters}">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th>Id</th>
			...
			<tr>
				<td class="center"><c:out value="${transporter.transporterId}"/></td>
				<td class="center"><c:out value="${transporter.transporterName}"/></td>
				<td class="center"><c:out value="${transporter.transporterAddress}"/></td>
				<td class="center"><c:out value="${transporter.locationId}"/></td>
				<td class="center"><c:out value="${transporter.contactNumber}"/></td>
				<td align="center"><a class="btn btn-info" href="editTransporter.html?transporterId=${transporter.transporterId}">
				<i class="halflings-icon white edit"></i>
				</a> | <a class="btn btn-danger" href="deleteTransporter.html?transporterId=${transporter.transporterId}">
